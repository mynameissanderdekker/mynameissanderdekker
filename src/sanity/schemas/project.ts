...
export const project = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'Select a Project Series — aanmaken via Studio → Project Series',
      type: 'array',
    ...
    defineField({
      ...
      description: 'Select linked exhibitions — aanmaken via Studio → Exhibitions',
      type: 'array',
    ...
    defineField({
      name: 'press',
      title: 'Press',
      description: 'Select press articles — aanmaken via Studio → Press',
      type: 'array',
